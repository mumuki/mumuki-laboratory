...
describe Exam do
  ...
  describe '#upsert' do
    ...
    let!(:exam) { Laboratory::Event::UpsertExam.execute! exam_json }
    context 'when new exam and the guide is the same' do
      ...
      let!(:exam2) { Laboratory::Event::UpsertExam.execute! exam_json2 }
  ...
  describe '#access!' do
    ...
    context 'enabled' do
      ...
      context 'import_from_json' do
        ...
        before { Laboratory::Event::UpsertExam.execute! exam_json }
        ...
        context 'existing exam' do
          ...
          before { Laboratory::Event::UpsertExam.execute! exam_json2 }
      ...
      context 'update exam does not change user started_at' do
        ...
        let(:exam) { Laboratory::Event::UpsertExam.execute! exam_json }
        before { exam.start! user }
        before { Laboratory::Event::UpsertExam.execute! exam_json.merge(tenant: 'test') }
      ...
      context 'create exam with non existing user' do
        ...
        it { expect { Laboratory::Event::UpsertExam.execute! exam_json.merge(tenant: 'test') }.not_to raise_error }
