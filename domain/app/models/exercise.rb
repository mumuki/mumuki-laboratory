class Exercise < ApplicationRecord
  ...
  def to_resource_h
    ...
    as_json(only: %i(name layout editor description corollary teacher_info hint test manual_evaluation locale
                     choices expectations assistance_rules randomizations tag_list extra_visible goal))
