...
feature 'Submit Flow' do
  ...
  let!(:exercise) {
    create(:exercise, tag_list: ['haskell'], name: 'Foo', description: 'an awesome problem description', guide: guide)
  }
  let!(:other_exercise) { create(:exercise, name: 'Baz', guide: guide) }
